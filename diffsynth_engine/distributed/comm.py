# Adapted from https://github.com/feifeibear/long-context-attention/blob/main/yunchang/comm/all_to_all.py
#              https://github.com/feifeibear/long-context-attention/blob/main/yunchang/ring/utils.py
